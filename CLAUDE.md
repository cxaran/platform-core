...
## Language
Code comments, docstrings, and user-facing API messages are written in **Spanish**. Match that when editing. (`CLAUDE.md` and `model-gateway/README.md` are the exceptions, in English.)
