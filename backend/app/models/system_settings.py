...
siembra con defaults seguros en la migración inicial y el bootstrap HTTP la
actualiza con las decisiones del asistente.
"""
...
class SystemSettings(Base):
    ...
    app_base_url: Mapped[Optional[str]] = mapped_column(
        ...
        nullable=True,
        comment=(
            "Dominio público de la instalación (https://…): base de los enlaces "
            "absolutos de correo y de los redirect URIs de OAuth."
        ),
    )
    ...
    site_description: Mapped[Optional[str]] = mapped_column(
        String(300),
        nullable=True,
        comment=(
